...
$name = 'Mad';
$fullname = 'Madara Semini';
$photo_name = 'uploads/download.jpg';
$msgquery = "select * from notification WHERE status=0";
...
<body>
    ...
    <div class="sidenav">
        ...
        <button class="accordion">My Classe</button>
        <div class="panel">
            <p>class list</p>
        </div>
        ...
        <button class="accordion">My Requests</button>
        <div class="panel">
            <p>Requesed list</p>
        </div>
    ...
    <div class="left-container">
        <div class="header">
            ...
            <div class="cards">
                ...
                <button class="card-desc" onclick="location.href='studentProfile.php'"> View profile</button>
            </div>
            <div class="card">
                    
                <img src="https://images.unsplash.com/photo-1534188753412-3e26d0d618d6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80" alt="">
                <button class="card-desc" onclick="location.href='adCollection.php'" type="button"> View Advertisements </button>
            </div>
            </div>
        ...
        <div class="notification">
            ...
            <div class="notification-list " id="dd">
                ...
                ?>
                            <a href="notifications.php?id=<?php echo $notif_id ?>">Request <?php echo $notif_msg; ?></a>
